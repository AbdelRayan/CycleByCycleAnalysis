...
WaveParam.DownSample=1; %DownSampling
WaveParam.wname='morl'; %Wavelet Name
...
% if ~isempty(SavePath)
   ...
   save('../output/output_wcoherGenzel_20hz_180hz_300s_fs1250hz.mat','sample','ThetaTS','LFPOutput1','LFPOutput2','WaveParam','PhaseBin','Fplot','Div','timerange', 'WCS', "-v7.3");
% end
toc
